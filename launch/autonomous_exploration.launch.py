...
def generate_launch_description():
    ...
    # Hardware bringup (EKF + SLAM + Nav2, no Gazebo)
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "use_sim",
            default_value="true",
            description="Whether to start the simulation (true) or use real hardware (false)",
        ),
        sim_and_nav,
        robot_nav,
        # T=18s Nav2 starts, T=32s explorer starts (14s for Nav2 to warm up).
